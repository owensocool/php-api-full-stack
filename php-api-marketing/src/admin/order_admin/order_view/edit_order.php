...
<body>
    ...
    <h2>แก้ไขข้อมูล Order</h2>
       <hr style='width: 85%; border: 1px solid #3A4D39;' />
        ...
        <form method="post" action="../order_controller/save_edit_order.php">
            ...
            <table width='500px'>
                <tr>
                    ...
                    <td><input type="hidden" name="order_id" required style="width: 95%; padding: 8px; margin: 10px; border: 1px solid #ccc; border-radius: 4px; box-sizing: border-box; background-color: #EEEEEE;"   value="<?php echo $row['order_id']; ?>"><a style="width: 95%; padding: 8px; margin: 10px;" ><?php echo $row['order_id']; ?></a> </td>
                </tr>
                <tr>
