...
<body>
    ...
    <header>
        ...
        <nav>
            ...
            <a href="../../order/order_view/search_order.php">ค้นหา Order</a>
        </nav>
        <a class="login-btn"></a>
    </header>
    ...
    if (!empty($cartItems)) {
        ...
        echo "<form method='post' action='../../order/order_view/order_form.php'>"; // Form to submit the order
        ...
        foreach ($cartItems as $index => $item) {
            ...
            echo "<tr>
                    ...
                    <td style='padding: 10px; text-align:center;'>
                        <a href='../cart_controller/remove_items.php?product_id={$item['product_id']}'>Delete</a>
                    </td>
                </tr>";
    ...
    ?>
            ...
            <script>
                ...
                function updateTotal(input, productPrice, index, productId) {
                    ...
                    $.ajax({
                        type: 'POST',
                        url: '../cart_controller/update_cart.php',
                        data: {
                            index: index,
                            productId: productId,
                            quantity: quantity
                    ...
                    totalCell.textContent = total.toFixed(2) + ' THB';
